...
static const int64 nTargetSpacing = 5 * 60; // Gaelcoin: 5 minutes
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "On 6 December 1922 the entire island of Ireland became a self-governing British dominion called the Irish Free State";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
